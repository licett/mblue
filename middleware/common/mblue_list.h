...
//#ifdef offsetof(TYPE, MEMBER)
//#undef offsetof(TYPE, MEMBER)
//#endif
...
{
	return (!list_empty(head) && (head->next == head->prev)) ? TRUE : FALSE;
}
